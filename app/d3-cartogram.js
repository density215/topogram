/**
 * Created by jasper on 28/07/16.
 * ES6 module version of http://prag.ma/code/d3-cartogram/cartogram.js
 * created by stamen.com
 */
...
export default function cartogram() {
    ...
    var iterations = 8,
        projection = geoMercator(), // This is the fallback if a projection wasn't specified by caller of cartogram()
...
// Copied over from d3 v3.5.17. Seems to be gone in v4.0.x
